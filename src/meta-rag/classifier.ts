...
export class QueryClassifier {
  ...
  private async classifyWithOllama(
    ...
    const prompt = `Classify this query into ONE type. Be precise.

Types:
- PROCEDURAL: "continue", "implement", "add", "create", "build"
- FACTUAL: "what is", "how does", "explain", "tell me about"
- ARCHITECTURAL: "structure", "dependencies", "imports", "architecture"
- USER: "my preferred", "my expertise", "I like", "I use"
- HISTORICAL: "decisions", "why did we", "history", "changes", "chose"
- GENERAL: unclear or doesn't fit

Query: "${query}"

JSON only:
{"type": "PROCEDURAL|FACTUAL|ARCHITECTURAL|USER|HISTORICAL|GENERAL", "confidence": 0.9, "reasoning": "brief"}`;
